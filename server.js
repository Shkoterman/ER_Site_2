...
app.get('/api/events', async (req, res) => {
    try {
        ...
        const fieldsToFetch = [
            'start_date', 'stop_date', 'str_date', 'dont_show_time',
            'Name_event', 'short_description', 'event_discriptoin',
            'cost_all', 'cost_more', 'Свободных мест', 'web_site_tag', 'place_name', 'place_adres',
            'place_link', 'Описание', 'image', 'web_site_tag',
            'external_link', 'profee_page_link'
        ];
...
app.get('/api/event/:eventId', async (req, res) => {
    try {
        ...
        const fieldsToFetch = [
            ...
            'cost_all', 'cost_more', 'Свободных мест', 'web_site_tag', 'place_name', 'place_adres',
            'place_link', 'Описание', 'image', 'web_site_tag',
            'external_link', 'profee_page_link', 'is_it_subscribers_only', 'Статус'
        ];
